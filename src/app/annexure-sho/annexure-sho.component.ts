...
@Component({
  selector: 'app-annexure-sho',
  templateUrl: './annexure-sho.component.html',
  styleUrls: ['./annexure-sho.component.css']
})
export class AnnexureSHOComponent implements OnInit {
  items: MenuItem[];
  visibleSidebar1;
